            ...
            <div class="content-layout">
                ...
                <form id="frm" class="form-horizontal editgoods grey edit-goods-new distProduct"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="filter-input-filed form-control" id="principal"
                                   placeholder="请输入主标题"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="filter-input-filed" id="pid" type="hidden" name="pid" value="0" type="text">
