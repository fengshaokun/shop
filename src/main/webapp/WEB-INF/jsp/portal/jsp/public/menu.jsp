    ...
    <div class="login_tag clearfix">
        <div class="am_tag">
            ...
            <span id="goods" class="fl orange hidden " style="line-height:50px;margin-left:20px;">
                <a href="http://localhost:8085/seller/toGoodsManagement" style="color:#6a6a6a;">我的商品</a>
            </span>

            <div class="notLoginBtns login-items fr">
                <span class="logined-show" id="userInfo"></span>
                <input type="hidden" id="userId" name="userId">
                <a id="needLogin" class="login sr-only" href="http://localhost:8081/user/toLogin">你好，请登录 </a>
                <a id="register" class="register logined-hide " href="http://localhost:8081/user/toRegister">用户注册</a>
                ...
                <a id="sellerCenter" class="my-center logined-show  sr-only" href="http://localhost:8085">卖家个人中心</a>
...
<script src="/portal/js/sso.js" type="text/javascript"></script>
